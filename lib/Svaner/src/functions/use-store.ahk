 ...
 * @property {Object<String, Any>} states
 * @property {Object<String, (this)=>Any>} deriveds
 * @property {Object<String, (this)=>void>} methods
 */
...
class useStore {
     ...
     * @param {StoreConfig} storeConfig Configuration object for the store.
     * ```
     * store := useStore({
     *     states: {
     *         count: 0
