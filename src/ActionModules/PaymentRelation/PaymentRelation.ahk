...
PaymentRelation(props) {
    ...
    pr.render := (this) => this.Add(
        ; pay for
        App.AddGroupBox("Section r5 " . s.panelWide . s.xPos . s.yPos, "P/F房(支付人)"),
        ...
        ; pay by
        App.AddGroupBox("Section r5 " . s.rPanelXPos . s.yPos . s.panelWide, "P/B房(被支付人)"),
        App.AddText("xs10 yp+25 h20 0x200", "房号         "),
        ...
        ; btns  
        App.ARButton("vPaymentRelationAction w300 h40 y+75 " . s.xPos, "粘 贴 信 息")
